...
- Tech used in this project
  ...
  - V86 emulation [V86](https://github.com/copy/v86) - Enables the emulation of Dos or Linux dsitribution on the Browser with webAssembly
...
- Features
  ...
  - linux emulation on the browser powered by V86 emulation
    V86 [V86](https://github.com/copy/v86)

  &nbsp;

   <img draggable={false} title="a title" alt="Alt text" src="./happensync.gif">

- bugs or what needs to be fixed ... in version 1.2.1

  1. needs to mount file system (it keeps spitting errors)
  1. needs to resize the emulation size dynamically
